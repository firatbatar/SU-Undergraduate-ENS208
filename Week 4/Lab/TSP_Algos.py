...
def two_opt(tour, tour_length, d):
    ...
    while solution_improved:
        print()
        print('Attempting to improve the tour', current_tour, 'with length', current_tour_length)
        ...
        for i in range(1, len(current_tour)-2):
            for j in range(i+1, len(current_tour)-1):
                ...
                print('Cost difference due to swapping', current_tour[i], 'and', current_tour[j], 'is:', difference)
                ...
                if current_tour_length + difference < best_tour_length:
                    ...
                    print('Improved tour is:', best_tour, 'with length', best_tour_length)
